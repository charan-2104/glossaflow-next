  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 uppercase tracking-wide",
  {
    variants: {
      variant: {
        ...
        default: "bg-white text-black border-2 border-slate-200 border-b-4 active:border-b-2 hover:bg-slate-100 text-slate-500",
        primary: "bg-sky-400 text-white hover:bg-sky-400/90 border-b-4 border-sky-500 active:border-b-0",
        primaryOutline: "bg-white text-sky-500 hover:bg-slate-100",
        secondary: "bg-green-500 text-white hover:bg-green-500/90 border-b-4 border-green-600 active:border-b-0",
        secondaryOutline: "bg-white text-green-500 hover:bg-slate-100",
        danger: "bg-rose-500 text-white hover:bg-rose-500/90 border-b-4 border-rose-600 active:border-b-0",
        dangerOutline: "bg-white text-red-500 hover:bg-slate-100",
        super: "bg-indigo-500 text-white hover:bg-indigo-500/90 border-b-4 border-indigo-600 active:border-b-0",
